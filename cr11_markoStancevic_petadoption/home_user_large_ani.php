...
<body>
	<hr>
	<h1 style="text-align: center;">Welcome to our large Friends !</h1>
	<hr>
	...
	<div class="container">
		<div class="row">
			...
			<?php
				...
				$sql = "SELECT * FROM animals WHERE ani_type = 'large'";
				...
				elseif($result->num_rows == 1)
				{
    				...
    				<p class='card-text'>".$row["ani_art"]."</p>
    				<p class='card-text'>".$row["med_title"]."</p>
