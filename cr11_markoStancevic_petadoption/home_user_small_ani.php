...
<body>
	<hr>
	<h1 style="text-align: center;">Welcome to our small Friends !</h1>
	<hr>
	...
	<div class="container">
		<div class="row">
			...
			<?php 
				...
				$sql = "SELECT * FROM animals WHERE ani_type = 'small'";
				...
				elseif($result->num_rows == 1)
				{
    				...
    				<a href='request.php?id=".$row["ani_id"]."' class='btn btn-primary'>Request</a>
				...
				else
				{
    				...
    				<a href='request.php?id=".$value["ani_id"]."' class='btn btn-primary'>Request</a>
